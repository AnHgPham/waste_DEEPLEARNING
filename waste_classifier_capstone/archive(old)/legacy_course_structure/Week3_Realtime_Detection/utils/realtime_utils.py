"""
Utility functions for real-time detection and visualization (Week 3)

This module provides helper functions for:
- Classifying a list of cropped images.
- Drawing bounding boxes and labels on the output frame.
- Managing the real-time detection loop.
